...
* Dictionary entries that could be interpreted as forcing a personal preference on users, E.G. entries that forcefully disable an abbreviation you don't like
